...
#define UDP_ECHO_PORT 6000 /* port for nc -u */
#define UDP_ECHO_QUEUE_MAX 512 /* max queued RX dgrams */
#define UDP_ECHO_RX_WAIT_TICKS 100 /* ~1 s at 100 ticks/s */
#define UDP_ECHO_BUFFER_SIZE 512 /* log buffer */
#define UDP_ECHO_THREAD_STACK_SIZE (2 * DEFAULT_MEMORY_SIZE)
#define UDP_ECHO_THREAD_PRIORITY (NETX_IP_THREAD_PRIORITY + 3) // Less than IP driver!
/* USER CODE END EC */
