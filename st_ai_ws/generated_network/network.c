...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0xdab9905d21f7ca7841d6027536d57dc3"
#define _STAI_NETWORK_DATETIME            "2026-09-12T00:08:52+0200"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 39904),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
{
  activation_output_array.data = AI_PTR(net_ctx->_activations[0] + 640);
  activation_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 640);
  max_pooling2d_output_array.data = AI_PTR(net_ctx->_activations[0] + 640);
  max_pooling2d_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 640);
...
static const ai_u32 conv2d_t_in_0_shape_h_const_u32 = 48;
static const ai_u32 conv2d_t_out_0_shape_w_const_u32 = 3;
static const ai_u32 conv2d_t_out_0_shape_h_const_u32 = 33;
...
static const ai_i32 activation_t_in_0_shape_ch_h_w_prod_const_s32 = 2376;
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d */
  {
    ...
    ai_float* conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 640);
    ...
    ai_float* conv2d_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 576);
  ...
  {
      ai_handle activation_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 640);
    const ai_handle activation_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 640);
  ...
  /* LITE_KERNEL_SECTION BEGIN dense */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 640),
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(5, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 640)});
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_1_dense */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 39696),
      .bias = (float*)(net_ctx->_weights[0] + 39888),
      .n_channel_in = 12,
      .n_channel_out = 4,
      .n_elements = 1,
    };
