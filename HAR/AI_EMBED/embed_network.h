...
#define STAI_EMBED_NETWORK_ORIGIN_MODEL_NAME         "st_ign_wl_24_embed"
#define STAI_EMBED_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xbea368760f8f6dfe3cead4742d6fb8b7"

/*  Generated model name and signature  */
#define STAI_EMBED_NETWORK_MODEL_NAME                "embed_network"
#define STAI_EMBED_NETWORK_MODEL_SIGNATURE           (0xd3923acb083fb574)
...
#define STAI_EMBED_NETWORK_MACC_NUM            (14328)

/*  Macros to declare input buffers characteristics  */
#define STAI_EMBED_NETWORK_IN_NUM              (1)
#define STAI_EMBED_NETWORK_IN_SIZE_BYTES       (292)
...
#define STAI_EMBED_NETWORK_IN_1_SHAPE       {1,24,3,1}
#define STAI_EMBED_NETWORK_IN_1_BATCH       (1)
#define STAI_EMBED_NETWORK_IN_1_CHANNEL     (24)
#define STAI_EMBED_NETWORK_IN_1_HEIGHT      (3)
#define STAI_EMBED_NETWORK_IN_1_WIDTH       (1)
#define STAI_EMBED_NETWORK_IN_1_RANK        (3)
#define STAI_EMBED_NETWORK_IN_1_SIZE        (72)
#define STAI_EMBED_NETWORK_IN_1_SIZE_BYTES  (288)
...
#define STAI_EMBED_NETWORK_ACTIVATIONS_SIZE              (2944)
#define STAI_EMBED_NETWORK_ACTIVATIONS_SIZE_BYTES        (2944)
...
#define STAI_EMBED_NETWORK_ACTIVATION_1_SIZE       (2944)
#define STAI_EMBED_NETWORK_ACTIVATION_1_SIZE_BYTES (2944)
...
#define STAI_EMBED_NETWORK_WEIGHTS_SIZE                  (12048)
#define STAI_EMBED_NETWORK_WEIGHTS_SIZE_BYTES            (12048)
...
#define STAI_EMBED_NETWORK_WEIGHT_1_SIZE        (12048)
#define STAI_EMBED_NETWORK_WEIGHT_1_SIZE_BYTES  (12048)
