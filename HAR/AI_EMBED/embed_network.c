...
#include "embed_network_details.h"
...
#ifndef _STAI_EMBED_NETWORK_EVENT_NODE_START_CB
  #define _STAI_EMBED_NETWORK_EVENT_NODE_START_CB(_node_id, _buffers_size, ...) \
...
#else
  #define _STAI_EMBED_NETWORK_EVENT_NODE_START_CB(_node_id, _buffers_size, ...) \
    do { /* _STAI_EMBED_NETWORK_EVENT_NODE_START_CB() */ } while(0);
#endif      /* STAI_EVENT_NODE_START_CB */

#ifdef STAI_EVENT_NODE_STOP_CB
#ifndef _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB
  #define _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB(_node_id, _buffers_size, ...) \
  if (net_ctx->_callback) { \
...
#else
  #define _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB(_node_id, _buffers_size, ...) \
    do { /* _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB() */ } while(0);
...
/*****************************************************************************/
#define g_embed_network_activations_1     (NULL)




#if defined(HAVE_EMBED_NETWORK_INFO)
/*****************************************************************************/
static const stai_network_info g_embed_network_info = {
  .model_signature = _STAI_EMBED_NETWORK_MODEL_SIGNATURE,
  .c_compile_datetime = _STAI_EMBED_NETWORK_COMPILE_DATETIME,
  .c_model_name = STAI_EMBED_NETWORK_MODEL_NAME,
  .c_model_datetime = _STAI_EMBED_NETWORK_DATETIME,
  .c_model_signature = 0x0,
  .runtime_version = STAI_INIT_VERSION(12, 0, 1),
  .tool_version = STAI_INIT_VERSION(4, 0, 1),
  .api_version = STAI_INIT_VERSION(1, 0, 0),
  .n_macc = STAI_EMBED_NETWORK_MACC_NUM,
  .n_nodes = STAI_EMBED_NETWORK_NODES_NUM,
  .flags = STAI_EMBED_NETWORK_FLAGS,
  .n_inputs = STAI_EMBED_NETWORK_IN_NUM,
  .n_outputs = STAI_EMBED_NETWORK_OUT_NUM,
  .n_activations = STAI_EMBED_NETWORK_ACTIVATIONS_NUM,
  .n_weights = STAI_EMBED_NETWORK_WEIGHTS_NUM,
  .n_states = STAI_EMBED_NETWORK_STATES_NUM,
  .inputs = (stai_tensor[STAI_EMBED_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      STAI_EMBED_NETWORK_IN_1_NAME,
    ...
    .outputs = (stai_tensor[STAI_EMBED_NETWORK_OUT_NUM]) {
    STAI_INIT_TENSOR(
      STAI_EMBED_NETWORK_OUT_1_NAME,
      STAI_EMBED_NETWORK_OUT_1_FLAGS,
      STAI_EMBED_NETWORK_OUT_1_FORMAT,
      STAI_EMBED_NETWORK_OUT_1_SIZE_BYTES,
      STAI_DECLARE_ARRAY(int32_t, 2, 1, 12),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .activations = (stai_tensor[STAI_EMBED_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      (NULL),
  ...
  .weights = (stai_tensor[STAI_EMBED_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      (NULL),
...
#define _STAI_CONTEXT_ACQUIRE(_net_ctx, _net_handle) \
  _stai_embed_network_context* _net_ctx = (_stai_embed_network_context*)(_net_handle); \
...
/*****************************************************************************/
static
void _stai_embed_network_check(_stai_embed_network_context* net_ctx)
{
  stai_size idx;

// Check activations status
  for (idx=0; idx<STAI_EMBED_NETWORK_ACTIVATIONS_NUM; idx++) {
    if (net_ctx->_activations[idx] == NULL) break;
  }
  net_ctx->_flags |= (idx == STAI_EMBED_NETWORK_ACTIVATIONS_NUM) ? STAI_FLAG_ACTIVATIONS : STAI_FLAG_NONE;
// Check inputs status
  for (idx=0; idx<STAI_EMBED_NETWORK_IN_NUM; idx++) {
    if (net_ctx->_inputs[idx] == NULL) break;
  }
  net_ctx->_flags |= (idx == STAI_EMBED_NETWORK_IN_NUM) ? STAI_FLAG_INPUTS : STAI_FLAG_NONE;

  // Check outputs status
  for (idx=0; idx<STAI_EMBED_NETWORK_OUT_NUM; idx++) {
    if (net_ctx->_outputs[idx] == NULL) break;
  }
  net_ctx->_flags |= (idx == STAI_EMBED_NETWORK_OUT_NUM) ? STAI_FLAG_OUTPUTS : STAI_FLAG_NONE;

// Check weights status
  for (idx=0; idx<STAI_EMBED_NETWORK_WEIGHTS_NUM; idx++) {
    if (net_ctx->_weights[idx] == NULL) break;
  }
  net_ctx->_flags |= (idx == STAI_EMBED_NETWORK_WEIGHTS_NUM) ? STAI_FLAG_WEIGHTS : STAI_FLAG_NONE;
  ...
  stai_network* network)
{
  ...
  _stai_embed_network_context* net_ctx = (_stai_embed_network_context*)(network);
  net_ctx->_return_code = STAI_SUCCESS;
  STAI_PRINT("[Entering Network Init] network(%p) context_size(%d)\n", net_ctx, (int32_t)sizeof(_stai_embed_network_context))

  _STAI_SET_ERROR(net_ctx, STAI_EMBED_NETWORK_CONTEXT_SIZE != sizeof(_stai_embed_network_context),
                 STAI_ERROR_NETWORK_INVALID_CONTEXT_SIZE, net_ctx->_return_code)

  {
    const _stai_embed_network_context _embed_network_context = {
      ._magic = STAI_MAGIC,
      ._signature = STAI_EMBED_NETWORK_MODEL_SIGNATURE,
      ._flags = STAI_EMBED_NETWORK_FLAGS,
      ._return_code = STAI_SUCCESS,
      ._callback = NULL,
      ._callback_cookie = NULL,
      ._activations = {
      (stai_ptr)g_embed_network_activations_1
      },
      ._weights = {
      (stai_ptr)g_embed_network_weights_array
      },
      ._inputs = {
    NULL},
      ._outputs = {
    ...
    *net_ctx = _embed_network_context;
  ...
  stai_network* network)
{
  ...
  net_ctx->_flags = STAI_EMBED_NETWORK_FLAGS;
  return net_ctx->_return_code;
}
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  functional_1_conv2d_1_BiasAdd__70_to_chfirst_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &input_tensor_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &functional_1_conv2d_1_BiasAdd__70_to_chfirst_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  functional_1_conv2d_1_BiasAdd__70_to_chfirst_layer, 1,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &functional_1_conv2d_1_BiasAdd__70_to_chfirst_chain,
  NULL, &functional_1_conv2d_1_BiasAdd__70_to_chfirst_layer, AI_STATIC, 
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  functional_1_max_pooling2d_1_MaxPool2d0_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &functional_1_activation_1_Relu0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &functional_1_max_pooling2d_1_MaxPool2d0_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  functional_1_max_pooling2d_1_MaxPool2d0_layer, 4,
  POOL_TYPE, 0x0, NULL,
  pool, forward_mp,
  &functional_1_max_pooling2d_1_MaxPool2d0_chain,
  NULL, &functional_1_max_pooling2d_1_MaxPool2d0_layer, AI_STATIC, 
  .pool_size = AI_SHAPE_2D_INIT(1, 3), 
  .pool_stride = AI_SHAPE_2D_INIT(1, 3), 
  .pool_pad = AI_SHAPE_INIT(4, 0, 0, 0, 0), 
)
/**  Hybrid layers declarations section  *************************************/
void forward_lite_transpose_functional_1_conv2d_1_BiasAdd__70_to_chfirst(_stai_embed_network_context* net_ctx)
{
...
void forward_lite_mp_functional_1_max_pooling2d_1_MaxPool2d0(_stai_embed_network_context* net_ctx)
{
  functional_1_activation_1_Relu0_output_array.data = AI_PTR(net_ctx->_activations[0] + 0);
  functional_1_activation_1_Relu0_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 0);
  functional_1_max_pooling2d_1_MaxPool2d0_output_array.data = AI_PTR(net_ctx->_activations[0] + 0);
  functional_1_max_pooling2d_1_MaxPool2d0_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 0);
  _STAI_EMBED_NETWORK_EVENT_NODE_START_CB(4, 1, { functional_1_activation_1_Relu0_output.data->data});
  forward_mp(&functional_1_max_pooling2d_1_MaxPool2d0_layer);
  _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB(4, 1, { functional_1_max_pooling2d_1_MaxPool2d0_output.data->data});
}
...
static const ai_i32 functional_1_conv2d_1_BiasAdd0_l_pad_H_0_const_s32 = 0;
static const ai_u16 functional_1_conv2d_1_BiasAdd0_l_stride_1_const_u16 = 1;
static const ai_u16 functional_1_conv2d_1_BiasAdd0_l_stride_0_const_u16 = 1;
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN functional_1_conv2d_1_BiasAdd__70_to_chfirst */
  {
    
  forward_lite_transpose_functional_1_conv2d_1_BiasAdd__70_to_chfirst(net_ctx);
  }
  ...
  forward_lite_conv2d_if32of32wf32(functional_1_conv2d_1_BiasAdd0_t_in_0_ptr_const_f32, functional_1_conv2d_1_BiasAdd0_t_out_0_ptr_f32, functional_1_conv2d_1_BiasAdd0_t_weight_0_ptr_const_u8, functional_1_conv2d_1_BiasAdd0_t_weight_1_ptr_const_u8, functional_1_conv2d_1_BiasAdd0_t_scratch_0_ptr_f32, functional_1_conv2d_1_BiasAdd0_t_in_0_shape_ch_const_u32, functional_1_conv2d_1_BiasAdd0_t_out_0_shape_ch_const_u32, functional_1_conv2d_1_BiasAdd0_t_in_0_shape_w_const_u32, functional_1_conv2d_1_BiasAdd0_t_in_0_shape_h_const_u32, functional_1_conv2d_1_BiasAdd0_t_out_0_shape_w_const_u32, functional_1_conv2d_1_BiasAdd0_t_out_0_shape_h_const_u32, functional_1_conv2d_1_BiasAdd0_t_weight_0_shape_w_const_u32, functional_1_conv2d_1_BiasAdd0_t_weight_0_shape_h_const_u32, functional_1_conv2d_1_BiasAdd0_l_pad_W_0_const_s32, functional_1_conv2d_1_BiasAdd0_l_pad_H_0_const_s32, functional_1_conv2d_1_BiasAdd0_l_stride_1_const_u16, functional_1_conv2d_1_BiasAdd0_l_stride_0_const_u16, 16, 1, functional_1_conv2d_1_BiasAdd0_l_dilation_H_const_u16, functional_1_conv2d_1_BiasAdd0_l_dilation_W_const_u16, (ai_size)(1));
    
  _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB(2, 1, {(stai_ptr) functional_1_conv2d_1_BiasAdd0_t_out_0_ptr_f32});
  }
  /* LITE_KERNEL_SECTION END functional_1_conv2d_1_BiasAdd0 */
  /* LITE_KERNEL_SECTION BEGIN functional_1_activation_1_Relu0 */
  {
      ai_handle functional_1_activation_1_Relu0_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 0);
    const ai_handle functional_1_activation_1_Relu0_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 0);
  
  _STAI_EMBED_NETWORK_EVENT_NODE_START_CB(3, 1, {(stai_ptr) functional_1_activation_1_Relu0_t_in_0_ptr_const_handle});
    
  forward_lite_nl_relu_if32of32(functional_1_activation_1_Relu0_t_out_0_ptr_handle, functional_1_activation_1_Relu0_t_in_0_ptr_const_handle, functional_1_activation_1_Relu0_t_in_0_shape_ch_h_w_prod_const_s32, NULL);
    
  _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB(3, 1, {(stai_ptr) functional_1_activation_1_Relu0_t_out_0_ptr_handle});
  }
  /* LITE_KERNEL_SECTION END functional_1_activation_1_Relu0 */
  /* LITE_KERNEL_SECTION BEGIN functional_1_max_pooling2d_1_MaxPool2d0 */
  {
    
  forward_lite_mp_functional_1_max_pooling2d_1_MaxPool2d0(net_ctx);
  }
  /* LITE_KERNEL_SECTION END functional_1_max_pooling2d_1_MaxPool2d0 */
  /* LITE_KERNEL_SECTION BEGIN Identity0 */
  {
  ...
  _STAI_EMBED_NETWORK_EVENT_NODE_START_CB(7, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 0)});
    
  forward_lite_dense_if32of32wf32((forward_lite_dense_if32of32wf32_args*)&arg_30f51e);
    
  _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB(7, 1, {(stai_ptr) (float*)(net_ctx->_outputs[0] + 0)});
  }
  /* LITE_KERNEL_SECTION END Identity0 */
  return net_ctx->_return_code;
}
...
STAI_API_ENTRY
stai_size stai_embed_network_get_context_size()
{
  return (stai_size)STAI_EMBED_NETWORK_CONTEXT_SIZE;
}
  ...
  stai_network* network, stai_ptr* activations, stai_size* n_activations)
{
  ...
  *n_activations = STAI_EMBED_NETWORK_ACTIVATIONS_NUM;
for (stai_size idx=0; activations && (idx<STAI_EMBED_NETWORK_ACTIVATIONS_NUM); idx++) {
  ...
  stai_network* network, stai_ptr* weights, stai_size* n_weights)
{
  ...
  *n_weights = STAI_EMBED_NETWORK_WEIGHTS_NUM;
for (stai_size idx=0; weights && (idx<STAI_EMBED_NETWORK_WEIGHTS_NUM); idx++) {
  ...
  stai_network* network, stai_ptr* inputs, stai_size* n_inputs)
{
  ...
  *n_inputs = STAI_EMBED_NETWORK_IN_NUM;
  for (stai_size idx=0; inputs && (idx<STAI_EMBED_NETWORK_IN_NUM); idx++) {
  ...
  stai_network* network, stai_ptr* outputs, stai_size* n_outputs)
{
  ...
  *n_outputs = STAI_EMBED_NETWORK_OUT_NUM;
  for (stai_size idx=0; outputs && (idx<STAI_EMBED_NETWORK_OUT_NUM); idx++) {
...
{
  _STAI_CONTEXT_ACQUIRE(net_ctx, network)
const uintptr_t _activations_alignment[] = STAI_EMBED_NETWORK_ACTIVATIONS_ALIGNMENTS;
  STAI_PRINT("  [stai_embed_network_set_activations] network(%p) activations[%d]: %p\n\n", net_ctx, n_activations, activations)
  _STAI_SET_ERROR(net_ctx, !activations,
                  STAI_ERROR_NETWORK_INVALID_API_ARGUMENTS, net_ctx->_return_code)
  _STAI_SET_ERROR(net_ctx, n_activations!=STAI_EMBED_NETWORK_ACTIVATIONS_NUM,
...
{
  _STAI_CONTEXT_ACQUIRE(net_ctx, network)
const uintptr_t _weights_alignment[] = STAI_EMBED_NETWORK_WEIGHTS_ALIGNMENTS;
  _STAI_SET_ERROR(net_ctx, !weights,
                  STAI_ERROR_NETWORK_INVALID_API_ARGUMENTS, net_ctx->_return_code)
  _STAI_SET_ERROR(net_ctx, n_weights!=STAI_EMBED_NETWORK_WEIGHTS_NUM,
...
{
  const uintptr_t _inputs_alignment[] = STAI_EMBED_NETWORK_IN_ALIGNMENTS;
  _STAI_CONTEXT_ACQUIRE(net_ctx, network)
  _STAI_SET_ERROR(net_ctx, !inputs,
                  STAI_ERROR_NETWORK_INVALID_API_ARGUMENTS, net_ctx->_return_code)
  _STAI_SET_ERROR(net_ctx, n_inputs!=STAI_EMBED_NETWORK_IN_NUM,
...
{
  const uintptr_t _outputs_alignment[] = STAI_EMBED_NETWORK_OUT_ALIGNMENTS;
  _STAI_CONTEXT_ACQUIRE(net_ctx, network)
  _STAI_SET_ERROR(net_ctx, !outputs,
                  STAI_ERROR_NETWORK_INVALID_API_ARGUMENTS, net_ctx->_return_code)
  _STAI_SET_ERROR(net_ctx, n_outputs!=STAI_EMBED_NETWORK_OUT_NUM,
...
#undef _STAI_EMBED_NETWORK_EVENT_NODE_START_CB
#undef _STAI_EMBED_NETWORK_EVENT_NODE_STOP_CB
#undef _STAI_EMBED_NETWORK_MODEL_SIGNATURE
#undef _STAI_EMBED_NETWORK_DATETIME
#undef _STAI_EMBED_NETWORK_COMPILE_DATETIME
