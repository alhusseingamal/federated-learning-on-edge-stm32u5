...
NUM_W = HEAD_NUM_CLASSES * HEAD_TOTAL_FEATURES   # 52
NUM_B = HEAD_NUM_CLASSES                          # 4
NUM_WEIGHTS = NUM_W + NUM_B                       # 56

PAYLOAD_FORMAT = f'<{NUM_WEIGHTS}f'
PAYLOAD_SIZE = struct.calcsize(PAYLOAD_FORMAT)    # 224

HANDSHAKE_FORMAT = '<I'
HANDSHAKE_SIZE = struct.calcsize(HANDSHAKE_FORMAT)  # 4
